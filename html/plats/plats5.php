...
<body>
  ...
  <div class="div-body">
        ...
        <article class="categorie" >
            <img src="/assets/img/plats/plat-sandwich/sandwich_fotios.png" alt="">
            <div class="div-text-categorie">
              <h1 class="menu-categorie-title"><a href="/html/categorie/pages_categorie_sandwich/pages_plats_sandwich/sandwich_fotios.php">Sandwich Fotios : </a></h1>
          ...
          <article class="categorie">
            <img src="/assets/img/plats/plat-sandwich/sandwich_gonzalo.png" alt="">
            <div class="div-text-categorie">
              <h1 class="menu-categorie-title"><a href="/html/categorie/pages_categorie_sandwich/pages_plats_sandwich/sandwich_gonzalo.php">Sandwich Gonzalo : </a></h1>
              <p class="categorie-text">
          ...
          <article class="categorie">
            <img src="/assets/img/plats/plat-sandwich/sandwich_martinez.png" alt="">
            <div class="div-text-categorie">
              <h1 class="menu-categorie-title"><a href="/html/categorie/pages_categorie_sandwich/pages_plats_sandwich/sandwich_martinez.php">Sandwich Martinez : </a></h1>
              <p class="categorie-text">
                La <b>cuisine asiatique</b> regroupe l'ensemble des styles gastronomiques des pays de d'Asie avec leur
                propres spécificités. Issu d'une identité commune, notamment par l'utilisation d'aliments de base comme le
                riz et le mode de cuisson, elles ont chacune leur spécificité locale.
          ...
          <article class="categorie">
            <img src="/assets/img/plats/plat-sandwich/sandwich_rajesh.png" alt="">
            <div class="div-text-categorie">
              <h1 class="menu-categorie-title"><a href="/html/categorie/pages_categorie_sandwich/pages_plats_sandwich/sandwich_rajesh.php">Sandwich Rajesh : </a></h1>
              <p class="categorie-text">
                La <b>cuisine asiatique</b> regroupe l'ensemble des styles gastronomiques des pays de d'Asie avec leur
                propres spécificités. Issu d'une identité commune, notamment par l'utilisation d'aliments de base comme le
                riz et le mode de cuisson, elles ont chacune leur spécificité locale.
    ...
    <div class="div-btn">
      <button class="btn-categorie"><a href="/html/plats/plats4.php">Précédent</a></button>
      <button class="btn-categorie"><a href="/html/plats/plats6.php">Suivant</a></button>
    </div>
  </div>
